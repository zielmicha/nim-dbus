...
proc dbus_error_init*(error: ptr DBusError) {.importc: "dbus_error_init", 
    dynlib: libdbus.}
proc dbus_error_free*(error: ptr DBusError) {.importc: "dbus_error_free", 
    dynlib: libdbus.}
proc dbus_set_error*(error: ptr DBusError; name: cstring; message: cstring) {.
    varargs, importc: "dbus_set_error", dynlib: libdbus.}
proc dbus_set_error_const*(error: ptr DBusError; name: cstring; message: cstring) {.
    importc: "dbus_set_error_const", dynlib: libdbus.}
proc dbus_move_error*(src: ptr DBusError; dest: ptr DBusError) {.
    importc: "dbus_move_error", dynlib: libdbus.}
proc dbus_error_has_name*(error: ptr DBusError; name: cstring): dbus_bool_t {.
    importc: "dbus_error_has_name", dynlib: libdbus.}
proc dbus_error_is_set*(error: ptr DBusError): dbus_bool_t {.
...
proc dbus_parse_address*(address: cstring; entry: ptr ptr ptr DBusAddressEntry; 
    ...
    importc: "dbus_parse_address", dynlib: libdbus.}
proc dbus_address_entry_get_value*(entry: ptr DBusAddressEntry; key: cstring): cstring {.
    importc: "dbus_address_entry_get_value", dynlib: libdbus.}
proc dbus_address_entry_get_method*(entry: ptr DBusAddressEntry): cstring {.
    importc: "dbus_address_entry_get_method", dynlib: libdbus.}
proc dbus_address_entries_free*(entries: ptr ptr DBusAddressEntry) {.
    importc: "dbus_address_entries_free", dynlib: libdbus.}
proc dbus_address_escape_value*(value: cstring): cstring {.
...
proc dbus_address_unescape_value*(value: cstring; error: ptr DBusError): cstring {.
    importc: "dbus_address_unescape_value", dynlib: libdbus.}
#* @} 
...
proc dbus_malloc*(bytes: csize): pointer {.importc: "dbus_malloc", 
    dynlib: libdbus.}
proc dbus_malloc0*(bytes: csize): pointer {.importc: "dbus_malloc0", 
    dynlib: libdbus.}
proc dbus_realloc*(memory: pointer; bytes: csize): pointer {.
    importc: "dbus_realloc", dynlib: libdbus.}
proc dbus_free*(memory: pointer) {.importc: "dbus_free", dynlib: libdbus.}
proc dbus_free_string_array*(str_array: cstringArray) {.
    importc: "dbus_free_string_array", dynlib: libdbus.}
type 
  DBusFreeFunction* = proc (memory: pointer)

proc dbus_shutdown*() {.importc: "dbus_shutdown", dynlib: libdbus.}
#* @} 
...
proc dbus_message_new*(message_type: cint): ptr DBusMessage {.
...
proc dbus_message_new_error_printf*(reply_to: ptr DBusMessage; 
    ...
    varargs, importc: "dbus_message_new_error_printf", dynlib: libdbus.}
proc dbus_message_copy*(message: ptr DBusMessage): ptr DBusMessage {.
    importc: "dbus_message_copy", dynlib: libdbus.}
proc dbus_message_ref*(message: ptr DBusMessage): ptr DBusMessage {.
    importc: "dbus_message_ref", dynlib: libdbus.}
proc dbus_message_unref*(message: ptr DBusMessage) {.
    importc: "dbus_message_unref", dynlib: libdbus.}
proc dbus_message_get_type*(message: ptr DBusMessage): cint {.
...
proc dbus_message_set_path*(message: ptr DBusMessage; object_path: cstring): dbus_bool_t {.
    importc: "dbus_message_set_path", dynlib: libdbus.}
proc dbus_message_get_path*(message: ptr DBusMessage): cstring {.
...
proc dbus_message_has_path*(message: ptr DBusMessage; object_path: cstring): dbus_bool_t {.
    importc: "dbus_message_has_path", dynlib: libdbus.}
proc dbus_message_set_interface*(message: ptr DBusMessage; iface: cstring): dbus_bool_t {.
    importc: "dbus_message_set_interface", dynlib: libdbus.}
proc dbus_message_get_interface*(message: ptr DBusMessage): cstring {.
...
proc dbus_message_has_interface*(message: ptr DBusMessage; iface: cstring): dbus_bool_t {.
    importc: "dbus_message_has_interface", dynlib: libdbus.}
proc dbus_message_set_member*(message: ptr DBusMessage; member: cstring): dbus_bool_t {.
    importc: "dbus_message_set_member", dynlib: libdbus.}
proc dbus_message_get_member*(message: ptr DBusMessage): cstring {.
...
proc dbus_message_has_member*(message: ptr DBusMessage; member: cstring): dbus_bool_t {.
    importc: "dbus_message_has_member", dynlib: libdbus.}
proc dbus_message_set_error_name*(message: ptr DBusMessage; name: cstring): dbus_bool_t {.
    importc: "dbus_message_set_error_name", dynlib: libdbus.}
proc dbus_message_get_error_name*(message: ptr DBusMessage): cstring {.
    importc: "dbus_message_get_error_name", dynlib: libdbus.}
proc dbus_message_set_destination*(message: ptr DBusMessage; 
                                   destination: cstring): dbus_bool_t {.
    importc: "dbus_message_set_destination", dynlib: libdbus.}
proc dbus_message_get_destination*(message: ptr DBusMessage): cstring {.
...
proc dbus_message_set_sender*(message: ptr DBusMessage; sender: cstring): dbus_bool_t {.
    importc: "dbus_message_set_sender", dynlib: libdbus.}
proc dbus_message_get_sender*(message: ptr DBusMessage): cstring {.
    importc: "dbus_message_get_sender", dynlib: libdbus.}
proc dbus_message_get_signature*(message: ptr DBusMessage): cstring {.
...
proc dbus_message_get_args*(message: ptr DBusMessage; error: ptr DBusError; 
                            first_arg_type: cint): dbus_bool_t {.varargs, 
...
proc dbus_message_contains_unix_fds*(message: ptr DBusMessage): dbus_bool_t {.
    importc: "dbus_message_contains_unix_fds", dynlib: libdbus.}
proc dbus_message_iter_init*(message: ptr DBusMessage; iter: ptr DBusMessageIter): dbus_bool_t {.
    importc: "dbus_message_iter_init", dynlib: libdbus.}
proc dbus_message_iter_has_next*(iter: ptr DBusMessageIter): dbus_bool_t {.
    importc: "dbus_message_iter_has_next", dynlib: libdbus.}
proc dbus_message_iter_next*(iter: ptr DBusMessageIter): dbus_bool_t {.
    importc: "dbus_message_iter_next", dynlib: libdbus.}
proc dbus_message_iter_get_signature*(iter: ptr DBusMessageIter): cstring {.
    importc: "dbus_message_iter_get_signature", dynlib: libdbus.}
proc dbus_message_iter_get_arg_type*(iter: ptr DBusMessageIter): cint {.
...
proc dbus_message_iter_get_element_type*(iter: ptr DBusMessageIter): cint {.
    importc: "dbus_message_iter_get_element_type", dynlib: libdbus.}
...
proc dbus_message_iter_get_basic*(iter: ptr DBusMessageIter; value: pointer) {.
    importc: "dbus_message_iter_get_basic", dynlib: libdbus.}
# This function returns the wire protocol size of the array in bytes,
#  you do not want to know that probably
# 

proc dbus_message_iter_get_array_len*(iter: ptr DBusMessageIter): cint {.
...
proc dbus_message_iter_get_fixed_array*(iter: ptr DBusMessageIter; 
    ...
    importc: "dbus_message_iter_get_fixed_array", dynlib: libdbus.}
...
proc dbus_message_iter_open_container*(iter: ptr DBusMessageIter; `type`: cint; 
    ...
    importc: "dbus_message_iter_open_container", dynlib: libdbus.}
proc dbus_message_iter_close_container*(iter: ptr DBusMessageIter; 
                                        sub: ptr DBusMessageIter): dbus_bool_t {.
    importc: "dbus_message_iter_close_container", dynlib: libdbus.}
proc dbus_message_iter_abandon_container*(iter: ptr DBusMessageIter; 
    sub: ptr DBusMessageIter) {.importc: "dbus_message_iter_abandon_container", 
                                dynlib: libdbus.}
proc dbus_message_lock*(message: ptr DBusMessage) {.
...
proc dbus_set_error_from_message*(error: ptr DBusError; message: ptr DBusMessage): dbus_bool_t {.
    importc: "dbus_set_error_from_message", dynlib: libdbus.}
proc dbus_message_allocate_data_slot*(slot_p: ptr dbus_int32_t): dbus_bool_t {.
    importc: "dbus_message_allocate_data_slot", dynlib: libdbus.}
proc dbus_message_free_data_slot*(slot_p: ptr dbus_int32_t) {.
...
proc dbus_message_set_data*(message: ptr DBusMessage; slot: dbus_int32_t; 
    ...
    importc: "dbus_message_set_data", dynlib: libdbus.}
proc dbus_message_get_data*(message: ptr DBusMessage; slot: dbus_int32_t): pointer {.
    importc: "dbus_message_get_data", dynlib: libdbus.}
proc dbus_message_type_from_string*(type_str: cstring): cint {.
    importc: "dbus_message_type_from_string", dynlib: libdbus.}
proc dbus_message_type_to_string*(`type`: cint): cstring {.
...
type 
  DBusWatchToggledFunction* = proc (watch: ptr DBusWatch; data: pointer)
...
type 
  DBusRemoveWatchFunction* = proc (watch: ptr DBusWatch; data: pointer)
...
type 
  DBusWakeupMainFunction* = proc (data: pointer)
...
proc dbus_connection_open*(address: cstring; error: ptr DBusError): ptr DBusConnection {.
    importc: "dbus_connection_open", dynlib: libdbus.}
proc dbus_connection_open_private*(address: cstring; error: ptr DBusError): ptr DBusConnection {.
    importc: "dbus_connection_open_private", dynlib: libdbus.}
proc dbus_connection_ref*(connection: ptr DBusConnection): ptr DBusConnection {.
    importc: "dbus_connection_ref", dynlib: libdbus.}
proc dbus_connection_unref*(connection: ptr DBusConnection) {.
    importc: "dbus_connection_unref", dynlib: libdbus.}
proc dbus_connection_close*(connection: ptr DBusConnection) {.
...
proc dbus_connection_get_is_connected*(connection: ptr DBusConnection): dbus_bool_t {.
    importc: "dbus_connection_get_is_connected", dynlib: libdbus.}
proc dbus_connection_get_is_authenticated*(connection: ptr DBusConnection): dbus_bool_t {.
    importc: "dbus_connection_get_is_authenticated", dynlib: libdbus.}
proc dbus_connection_get_is_anonymous*(connection: ptr DBusConnection): dbus_bool_t {.
    importc: "dbus_connection_get_is_anonymous", dynlib: libdbus.}
proc dbus_connection_get_server_id*(connection: ptr DBusConnection): cstring {.
    importc: "dbus_connection_get_server_id", dynlib: libdbus.}
proc dbus_connection_can_send_type*(connection: ptr DBusConnection; `type`: cint): dbus_bool_t {.
    importc: "dbus_connection_can_send_type", dynlib: libdbus.}
proc dbus_connection_set_exit_on_disconnect*(connection: ptr DBusConnection; 
    exit_on_disconnect: dbus_bool_t) {.importc: "dbus_connection_set_exit_on_disconnect", 
                                       dynlib: libdbus.}
proc dbus_connection_flush*(connection: ptr DBusConnection) {.
...
proc dbus_connection_read_write*(connection: ptr DBusConnection; 
                                 timeout_milliseconds: cint): dbus_bool_t {.
    importc: "dbus_connection_read_write", dynlib: libdbus.}
proc dbus_connection_borrow_message*(connection: ptr DBusConnection): ptr DBusMessage {.
    importc: "dbus_connection_borrow_message", dynlib: libdbus.}
...
proc dbus_connection_send_with_reply_and_block*(connection: ptr DBusConnection; 
    ...
    importc: "dbus_connection_send_with_reply_and_block", dynlib: libdbus.}
...
proc dbus_connection_set_dispatch_status_function*(
    ...
    data: pointer; free_data_function: DBusFreeFunction) {.
...
proc dbus_connection_get_unix_process_id*(connection: ptr DBusConnection; 
    pid: ptr culong): dbus_bool_t {.importc: "dbus_connection_get_unix_process_id", 
                                    dynlib: libdbus.}
proc dbus_connection_get_adt_audit_session_data*(connection: ptr DBusConnection; 
    data: ptr pointer; data_size: ptr dbus_int32_t): dbus_bool_t {.
...
proc dbus_connection_get_windows_user*(connection: ptr DBusConnection; 
    ...
    importc: "dbus_connection_get_windows_user", dynlib: libdbus.}
...
proc dbus_connection_set_allow_anonymous*(connection: ptr DBusConnection; 
    value: dbus_bool_t) {.importc: "dbus_connection_set_allow_anonymous", 
                          dynlib: libdbus.}
proc dbus_connection_set_route_peer_messages*(connection: ptr DBusConnection; 
    value: dbus_bool_t) {.importc: "dbus_connection_set_route_peer_messages", 
                          dynlib: libdbus.}
# Filters 
...
proc dbus_connection_add_filter*(connection: ptr DBusConnection; 
                                 ...
                                 user_data: pointer; 
                                 free_data_function: DBusFreeFunction): dbus_bool_t {.
    importc: "dbus_connection_add_filter", dynlib: libdbus.}
...
proc dbus_connection_allocate_data_slot*(slot_p: ptr dbus_int32_t): dbus_bool_t {.
    importc: "dbus_connection_allocate_data_slot", dynlib: libdbus.}
proc dbus_connection_free_data_slot*(slot_p: ptr dbus_int32_t) {.
...
proc dbus_connection_send_preallocated*(connection: ptr DBusConnection; 
    ...
    importc: "dbus_connection_send_preallocated", dynlib: libdbus.}
...
type 
  DBusObjectPathMessageFunction* = proc (connection: ptr DBusConnection; 
      message: ptr DBusMessage; user_data: pointer): DBusHandlerResult
...
type 
  DBusObjectPathVTable* = object 
    ...
    dbus_internal_pad1*: proc (a2: pointer) #*< Reserved for future expansion 
    dbus_internal_pad2*: proc (a2: pointer) #*< Reserved for future expansion 
    dbus_internal_pad3*: proc (a2: pointer) #*< Reserved for future expansion 
    dbus_internal_pad4*: proc (a2: pointer) #*< Reserved for future expansion 
...
proc dbus_connection_try_register_object_path*(connection: ptr DBusConnection; 
    ...
    error: ptr DBusError): dbus_bool_t {.
...
proc dbus_connection_register_object_path*(connection: ptr DBusConnection; 
    ...
    importc: "dbus_connection_register_object_path", dynlib: libdbus.}
...
proc dbus_connection_register_fallback*(connection: ptr DBusConnection; 
    ...
    importc: "dbus_connection_register_fallback", dynlib: libdbus.}
proc dbus_connection_unregister_object_path*(connection: ptr DBusConnection; 
    path: cstring): dbus_bool_t {.importc: "dbus_connection_unregister_object_path", 
                                  dynlib: libdbus.}
proc dbus_connection_get_object_path_data*(connection: ptr DBusConnection; 
    path: cstring; data_p: ptr pointer): dbus_bool_t {.
...
proc dbus_watch_get_fd*(watch: ptr DBusWatch): cint {.
    importc: "dbus_watch_get_fd", dynlib: libdbus.}
proc dbus_watch_get_unix_fd*(watch: ptr DBusWatch): cint {.
    importc: "dbus_watch_get_unix_fd", dynlib: libdbus.}
proc dbus_watch_get_socket*(watch: ptr DBusWatch): cint {.
    importc: "dbus_watch_get_socket", dynlib: libdbus.}
proc dbus_watch_get_flags*(watch: ptr DBusWatch): cuint {.
    importc: "dbus_watch_get_flags", dynlib: libdbus.}
proc dbus_watch_get_data*(watch: ptr DBusWatch): pointer {.
...
proc dbus_watch_handle*(watch: ptr DBusWatch; flags: cuint): dbus_bool_t {.
    importc: "dbus_watch_handle", dynlib: libdbus.}
proc dbus_watch_get_enabled*(watch: ptr DBusWatch): dbus_bool_t {.
...
proc dbus_timeout_get_interval*(timeout: ptr DBusTimeout): cint {.
    importc: "dbus_timeout_get_interval", dynlib: libdbus.}
proc dbus_timeout_get_data*(timeout: ptr DBusTimeout): pointer {.
...
proc dbus_timeout_handle*(timeout: ptr DBusTimeout): dbus_bool_t {.
    importc: "dbus_timeout_handle", dynlib: libdbus.}
proc dbus_timeout_get_enabled*(timeout: ptr DBusTimeout): dbus_bool_t {.
...
proc dbus_bus_add_match*(connection: ptr DBusConnection; rule: cstring; 
                         error: ptr DBusError) {.importc: "dbus_bus_add_match", 
    dynlib: libdbus.}
...
proc dbus_pending_call_ref*(pending: ptr DBusPendingCall): ptr DBusPendingCall {.
    importc: "dbus_pending_call_ref", dynlib: libdbus.}
proc dbus_pending_call_unref*(pending: ptr DBusPendingCall) {.
...
proc dbus_pending_call_set_notify*(pending: ptr DBusPendingCall; 
    ...
    importc: "dbus_pending_call_set_notify", dynlib: libdbus.}
proc dbus_pending_call_cancel*(pending: ptr DBusPendingCall) {.
...
proc dbus_pending_call_get_completed*(pending: ptr DBusPendingCall): dbus_bool_t {.
    importc: "dbus_pending_call_get_completed", dynlib: libdbus.}
proc dbus_pending_call_steal_reply*(pending: ptr DBusPendingCall): ptr DBusMessage {.
    importc: "dbus_pending_call_steal_reply", dynlib: libdbus.}
proc dbus_pending_call_block*(pending: ptr DBusPendingCall) {.
...
proc dbus_pending_call_allocate_data_slot*(slot_p: ptr dbus_int32_t): dbus_bool_t {.
    importc: "dbus_pending_call_allocate_data_slot", dynlib: libdbus.}
proc dbus_pending_call_free_data_slot*(slot_p: ptr dbus_int32_t) {.
    importc: "dbus_pending_call_free_data_slot", dynlib: libdbus.}
proc dbus_pending_call_set_data*(pending: ptr DBusPendingCall; 
                                 slot: dbus_int32_t; data: pointer; 
                                 free_data_func: DBusFreeFunction): dbus_bool_t {.
    importc: "dbus_pending_call_set_data", dynlib: libdbus.}
...
proc dbus_server_listen*(address: cstring; error: ptr DBusError): ptr DBusServer {.
    importc: "dbus_server_listen", dynlib: libdbus.}
proc dbus_server_ref*(server: ptr DBusServer): ptr DBusServer {.
    importc: "dbus_server_ref", dynlib: libdbus.}
proc dbus_server_unref*(server: ptr DBusServer) {.importc: "dbus_server_unref", 
    dynlib: libdbus.}
proc dbus_server_disconnect*(server: ptr DBusServer) {.
    importc: "dbus_server_disconnect", dynlib: libdbus.}
proc dbus_server_get_is_connected*(server: ptr DBusServer): dbus_bool_t {.
    importc: "dbus_server_get_is_connected", dynlib: libdbus.}
proc dbus_server_get_address*(server: ptr DBusServer): cstring {.
    importc: "dbus_server_get_address", dynlib: libdbus.}
proc dbus_server_get_id*(server: ptr DBusServer): cstring {.
...
proc dbus_server_set_watch_functions*(server: ptr DBusServer; 
    ...
    toggled_function: DBusWatchToggledFunction; data: pointer; 
                                      free_data_function: DBusFreeFunction): dbus_bool_t {.
    importc: "dbus_server_set_watch_functions", dynlib: libdbus.}
proc dbus_server_set_timeout_functions*(server: ptr DBusServer; 
    ...
    remove_function: DBusRemoveTimeoutFunction; toggled_function: DBusTimeoutToggledFunction; 
                                        data: pointer; 
                                        free_data_function: DBusFreeFunction): dbus_bool_t {.
    importc: "dbus_server_set_timeout_functions", dynlib: libdbus.}
proc dbus_server_set_auth_mechanisms*(server: ptr DBusServer; 
                                      mechanisms: cstringArray): dbus_bool_t {.
    importc: "dbus_server_set_auth_mechanisms", dynlib: libdbus.}
proc dbus_server_allocate_data_slot*(slot_p: ptr dbus_int32_t): dbus_bool_t {.
    importc: "dbus_server_allocate_data_slot", dynlib: libdbus.}
proc dbus_server_free_data_slot*(slot_p: ptr dbus_int32_t) {.
    importc: "dbus_server_free_data_slot", dynlib: libdbus.}
proc dbus_server_set_data*(server: ptr DBusServer; slot: cint; data: pointer; 
                           free_data_func: DBusFreeFunction): dbus_bool_t {.
    importc: "dbus_server_set_data", dynlib: libdbus.}
proc dbus_server_get_data*(server: ptr DBusServer; slot: cint): pointer {.
...
proc dbus_signature_validate*(signature: cstring; error: ptr DBusError): dbus_bool_t {.
    importc: "dbus_signature_validate", dynlib: libdbus.}
proc dbus_signature_validate_single*(signature: cstring; error: ptr DBusError): dbus_bool_t {.
    importc: "dbus_signature_validate_single", dynlib: libdbus.}
proc dbus_type_is_valid*(typecode: cint): dbus_bool_t {.
    importc: "dbus_type_is_valid", dynlib: libdbus.}
proc dbus_type_is_basic*(typecode: cint): dbus_bool_t {.
    importc: "dbus_type_is_basic", dynlib: libdbus.}
proc dbus_type_is_container*(typecode: cint): dbus_bool_t {.
    importc: "dbus_type_is_container", dynlib: libdbus.}
proc dbus_type_is_fixed*(typecode: cint): dbus_bool_t {.
...
type 
  DBusRecursiveMutexNewFunction* = proc (): ptr DBusMutex

#* Frees a recursively-lockable mutex.  Found in #DBusThreadFunctions.
# 

type 
  DBusRecursiveMutexFreeFunction* = proc (mutex: ptr DBusMutex)
...
type 
  DBusRecursiveMutexLockFunction* = proc (mutex: ptr DBusMutex)
...
type 
  DBusRecursiveMutexUnlockFunction* = proc (mutex: ptr DBusMutex)
...
type 
  DBusCondVarNewFunction* = proc (): ptr DBusCondVar

#* Frees a condition variable.  Found in #DBusThreadFunctions.
# 

type 
  DBusCondVarFreeFunction* = proc (cond: ptr DBusCondVar)
...
type 
  DBusCondVarWaitTimeoutFunction* = proc (cond: ptr DBusCondVar; 
      mutex: ptr DBusMutex; timeout_milliseconds: cint): dbus_bool_t
...
type 
  DBusCondVarWakeOneFunction* = proc (cond: ptr DBusCondVar)
...
type 
  DBusCondVarWakeAllFunction* = proc (cond: ptr DBusCondVar)
...
type 
  DBusThreadFunctions* = object 
    ...
    padding1*: proc ()        #*< Reserved for future expansion 
    padding2*: proc ()        #*< Reserved for future expansion 
    padding3*: proc ()        #*< Reserved for future expansion 
    padding4*: proc ()        #*< Reserved for future expansion 
  

proc dbus_threads_init*(functions: ptr DBusThreadFunctions): dbus_bool_t {.
    importc: "dbus_threads_init", dynlib: libdbus.}
proc dbus_threads_init_default*(): dbus_bool_t {.
